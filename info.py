...
WARN_MESSAGE = environ.get("WARN_MESSAGE", "ভাই, দুঃখিত, আপনাকে সাময়িক মিউট করা হয়েছে, নিচের চ্যানেল গুলোতে জয়েন করার পর আনমিউট বাটনে ক্লিক করে আনমিউট হয়ে নিন, আনমিউট হওয়ার পর গ্রুপে ব্যবহার করতে পারবেন।")
