...
WARN_MESSAGE = environ.get("WARN_MESSAGE", "দুঃখিত 😐 আপনি এখনো গ্রুপের চ্যানলে জয়েন করেননি, আপনাকে সাময়িক মিউট 🔇 করা হয়েছে, গ্রুপের চ্যানেল গুলোতে জয়েন করার পর আনমিউট বাটনে ক্লিক করে আনমিউট হয়ে নিন, আনমিউট হওয়ার পর গ্রুপে ব্যবহার করতে পারবেন।")

# GDrive Search Config
RESULTS_COUNT = 6  # NOTE Nuber of results to show, 4 is better
SUDO_CHATS_ID = [ 993876207, -575492766, -1001319419576, -1001190259319, -1001352599350, 1304152521, 993876207, -497415557, -1001620235788, 1224542559]
