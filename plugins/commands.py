...
@Client.on_message(filters.command("find") & ~filters.edited & filters.chat(SUDO_CHATS_ID))
...
@Client.on_message(filters.command("s") & ~filters.edited & filters.chat(SUDO_CHATS_ID))
...
@Client.on_message(filters.command("f") & ~filters.edited & filters.chat(SUDO_CHATS_ID))
...
async def info(_, update: Message):
    if update.reply_to_message:
        last_name = update.reply_to_message.from_user.last_name
    elif not update.reply_to_message and len(update.command) == 1:
        last_name = update.from_user.last_name
    elif not update.reply_to_message and len(update.command) != 1:
        last_name = update.text.split(None, 1)[1]
    else:
        last_name = "None"
    text = f"""
*** ℹ️ 𝐅𝐔𝐋𝐋 𝐔𝐒𝐄𝐑 𝐈𝐍𝐅𝐎 ℹ️ ***
**🕵️‍♂️ 𝘜𝘴𝘦𝘳 𝘐𝘋 :**<code> {update.from_user.id} </code>
**🗣 𝘍𝘪𝘳𝘴𝘵 𝘕𝘢𝘮𝘦 :** {update.from_user.first_name}
**🗣 𝘓𝘢𝘴𝘵 𝘕𝘢𝘮𝘦 :** {last_name}
**🕵️‍ 𝘜𝘴𝘦𝘳𝘯𝘢𝘮𝘦 :** {update.from_user.username}
**🔗 𝘗𝘳𝘰𝘧𝘪𝘭𝘦 𝘓𝘪𝘯𝘬 :**  {update.from_user.mention}
**🏢 𝘋𝘢𝘵𝘢 𝘊𝘦𝘯𝘵𝘦𝘳 𝘐𝘋 :** {update.from_user.dc_id}
**📲 𝘗𝘩𝘰𝘯𝘦 𝘕𝘶𝘮𝘣𝘦𝘳 :** {update.from_user.phone_number}
**👁 𝘓𝘢𝘴𝘵 𝘚𝘦𝘦𝘯 :** {update.from_user.status}
**🤖 𝘐𝘴 𝘉𝘰𝘵 :** {update.from_user.is_bot}
**🚫 𝘐𝘴 𝘍𝘢𝘬𝘦 :** {update.from_user.is_fake}
**🚫 𝘐𝘴 𝘚𝘤𝘢𝘮 :** {update.from_user.is_scam}
**🚫 𝘐𝘴 𝘙𝘦𝘴𝘵𝘳𝘪𝘤𝘵𝘦𝘥 :**{update.from_user.is_scam}
**✅ 𝘐𝘴 𝘝𝘦𝘳𝘪𝘧𝘪𝘦𝘥 𝘣𝘺 𝘛𝘦𝘭𝘦𝘨𝘳𝘢𝘮 :** {update.from_user.is_verified}
""" 
    reply_markup = DEFAULT_START_MARKUP
...
async def id(_, update):
    text = f"""
**🆔 𝘜𝘴𝘦𝘳 𝘐𝘋:**<code> {update.from_user.id} </code>
**🙋🏻‍♂️ 𝘍𝘪𝘳𝘴𝘵 𝘕𝘢𝘮𝘦 :** {update.from_user.first_name}
**🧑🏻‍🎓 𝘜𝘴𝘦𝘳𝘯𝘢𝘮𝘦 :** {update.from_user.username}
**🔗 𝘗𝘳𝘰𝘧𝘪𝘭𝘦 𝘓𝘪𝘯𝘬 :** {update.from_user.mention}
"""
    reply_markup = DEFAULT_START_MARKUP
    await update.reply_text(        
